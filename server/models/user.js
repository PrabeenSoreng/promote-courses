...
const userSchema = new Schema({
  ...
  name: {
    type: String,
    required: true,
    minlength: [6, "Too short, minimum length is 6 characters."]
  },
  username: {
    type: String,
    required: true,
  ...
  password: {
    type: String,
    minlength: [4, "Too short, minimum length is 4 characters."],
    maxlength: [32, "Too long, maximum length is 32 characters."],
